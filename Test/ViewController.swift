...
//  Test
//
//  Created by WeiHu on 2016/11/21.
...
struct Preference {
    ...
    var uri:String? = "rtmp://10.14.219.26/live/2005"
...
final class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        publishButton.addTarget(self, action: #selector(ViewController.on22222222(_:)), for: .touchUpInside)
        pauseButton.addTarget(self, action: #selector(ViewController.on11111111(_:)), for: .touchUpInside)
...
//    }
    ...
    func on11111111(_ pause:UIButton) {
        print("pause")
        rtmpStream.togglePause()
    }
    
    func on22222222(_ publish:UIButton) {
